...
const main = async () => {
	...
	// const testsData = Extractor.parseTest();
	// const testCreated = await Creator.createItems(testsData.testsList);
	// const testLocalCreated = await Creator.createItemsLocal(testsData.testsList, 'zh');
